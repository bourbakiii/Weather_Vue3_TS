...
// async function getWeatherByCoordinates<T extends {name:string, geo_lat:string, geo_lon:string}>(city: T) {
//   console.log(
//     await axios.get(
//       `https://api.openweathermap.org/data/2.5/onecall?lat=${city.geo_lat}&lon=${city.geo_lon}&appid=${WEATHER_TOKEN}`
//     )
//   );
// }
